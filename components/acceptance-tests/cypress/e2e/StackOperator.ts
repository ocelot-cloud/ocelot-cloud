import {areRealDockerContainersUsed, ocelotUrl, isSecurityEnabled, rootDomain, scheme} from "./Config";
...
export class StackOperator {
    ...
    assertStateWithLongWaitingTime(expectedState: ExpectedState): StackOperator {
        const options = {timeout: 30000};
        this.getStackRow().contains(expectedState, options);
        return this;
    }
